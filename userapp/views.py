...
def User_listbook(request):
    ...
    return render(request,'user/listbooks_userview.html',{'books' : books,'page':page})


def User_bookdetailsView(request,book_id):

    book = Book.objects.get(id=book_id)
    return render(request,'user/bookdetails_userview.html',{'book' : book})
...
def User_Search_Book(request):
    ...
    return render(request,'user/search_userview.html',context)
...
def create_chekout_session(request):
